...
int main(int, char const *[]) {
	...
	while (T--) {
		...
		if (Y == N) {
			if (J != N) {
				ans += choose(X - 1, I - 1) * choose(Y - X - 1, J - I - 1);
			}
		} else {
			RF(i, I + 1, J) {
				LL n1{X - 1}, k1{I - 1}, n3{N - Y - 1}, k3{J - i - 1},
					n2{N - X - 1 - 1 - n3}, k2{i - I - 1 - (n3 - k3)};
				ans += choose(n1, k1) * choose(n2, k2) * choose(n3, k3);
			}
			RF(i, J + 1, N) {
				LL n1{X - 1}, k1{I - 1}, n2{Y - X - 1}, k2{J - I - 1}, n3{N - Y - 1},
					k3{i - J - 1};
				ans += choose(n1, k1) * choose(n2, k2) * choose(n3, k3);
			}
		}
