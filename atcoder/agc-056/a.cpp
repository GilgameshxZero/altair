...
int main(int argc, char const *argv[]) {
	...
	RF(i, 0, N / 6) {
		RF(j, i * 6, i * 6 + 6) {
			RF(k, i * 6, i * 6 + 6) { g[j][k] = r[0][j - i * 6][k - i * 6]; }
		}
	}
	...
	switch (N - i) {
		case 1: {
			g[i][i] = '#';
			g[0][4] = g[1][4] = g[4][0] = g[4][1] = '.';
			g[0][i] = g[1][i] = g[i][0] = g[i][1] = '#';
			break;
		}
		case 2: {
			g[i][i] = g[i + 1][i + 1] = '#';
			g[0][4] = g[1][4] = g[4][0] = g[4][1] = '.';
			g[0][i] = g[1][i] = g[i][0] = g[i][1] = '#';
			g[0][i + 1] = g[1][i + 1] = g[i + 1][0] = g[i + 1][1] = '#';
			break;
		}
		case 3: {
			g[i][i] = g[i][i + 1] = g[i + 1][i] = g[i + 1][i + 1] = g[i + 2][i + 1] =
				g[i + 1][i + 2] = g[i + 2][i + 2] = '#';
			g[0][4] = g[1][4] = g[4][0] = g[4][1] = '.';
			g[0][i] = g[1][i + 2] = g[i][0] = g[i + 2][1] = '#';
			break;
		}
		case 4: {
			g[0][4] = g[1][4] = g[4][0] = g[4][1] = '.';
			g[i][i] = g[i][i + 1] = g[i + 1][i] = g[i + 1][i + 1] = '#';
			g[i + 2][i + 2] = g[i + 2][i + 3] = g[i + 3][i + 2] = g[i + 3][i + 3] =
				'#';
			g[i][i + 2] = g[i + 3][i + 1] = '#';
			g[0][i] = g[1][i + 3] = g[i + 1][0] = g[i + 2][1] = '#';
			break;
		}
		case 5: {
			g[i][i] = g[i][i + 1] = g[i + 1][i] = g[i + 1][i + 1] = '#';
			g[i + 2][i + 2] = g[i + 2][i + 3] = g[i + 3][i + 2] = g[i + 3][i + 3] =
				'#';
			g[i + 4][i + 4] = g[i][i + 4] = g[i + 1][i + 4] = g[i + 4][i] =
				g[i + 4][i + 1] = '#';
			break;
		}
	}
